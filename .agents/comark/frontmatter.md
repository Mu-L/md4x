...
- label: Frontmatter Plugin
  icon: i-lucide-plug
  to: /plugins/defaults/frontmatter
  color: neutral
  variant: soft
...
Comark supports YAML frontmatter at the beginning of documents. Parsing is provided by the built-in [`frontmatter` plugin](/plugins/defaults/frontmatter) (enabled by default).
...
See the [frontmatter plugin](/plugins/defaults/frontmatter) for registration and options.
