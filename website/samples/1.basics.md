---
title: MD4x Demo
tags: [math, frontmatter]
---

# Hello md4x

This is a **live** _playground_ for [md4x](https://github.com/unjs/md4x) — a fast markdown parser and renderer.

## Inline Formatting

**Bold text**, _italic text_, **also bold**, ~~strikethrough~~, and `inline code`.

You can also **combine _bold and italic_** or ~~**bold strikethrough**~~.

## Links & Autolinks

- [Explicit link](https://github.com/unjs/md4x)
